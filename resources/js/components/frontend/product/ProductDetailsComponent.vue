        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-12 sm:col-6 lg:col-7 lg:pl-10">
                    <h2 class="text-3xl sm:text-4xl font-bold capitalize mb-5">
                        {{ product.name }}
                    </h2>
                    ...
                    <VariationComponent
                        v-if="
                            initialVariations.length > 0 && variationComponent
                        "
                    ...
                    <div class="flex flex-wrap items-center gap-8 mb-10">
                        ...
                        <button
                            type="button"
                            @click="
                                wishlist((product.wishlist = !product.wishlist))
                            "
                            :class="
                                product.wishlist
                                    ? 'text-primary'
...
export default {
    ...
    methods: {
        ...
        addToCart: function () {
            ...
            console.log("ACAAAA----", this.productArray);

            if (this.selectedVariation) {
                console.log("Entro al if");
                console.log("ACAAAA----", this.productArray);
                console.log("ACAAAASELECTED----", this.selectedVariation);
                this.$store
                    .dispatch(
                    ...
                    .then((res) => {
                        console.log("ACAAAA----DATA", res.data.data);
                        console.log(
                            "ACAAAA---selectedVariation",
                ...
                console.log("Este es el productArray", this.productArray);
            }
            console.log("Sale de addToCart2==========");
        },
    },
    watch: {
        $route() {
