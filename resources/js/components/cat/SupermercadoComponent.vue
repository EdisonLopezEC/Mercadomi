<template>
    <div>
        <a href="#" class="block w-full h-full relative">
            <img
                ...
                src="https://mercadomi.com.ec/storage/31/conversions/supermercado.png"
                alt="banner"
                loading="lazy"
            />
    ...
    <section v-if="categories.length > 0" class="sm:mb-10 hidden">
        <div class="container">
            <h2 class="text-2xl sm:text-4xl font-bold -mb-10">
            ...
            >
                ...
                >
                    ...
                    >
                        <img
                            class="w-full block rounded-tl-2xl rounded-tr-2xl"
                            :src="category.thumb"
                            alt="category"
                            loading="lazy"
                        />
            ...
            staticCategories: [
                {
                    title: "SECCIÓN",
                    name: "ALIMENTOS",
                    link: "/#/product?category=alimentos",
                    buttonText: "VISÍTANOS",
                },
                {
                    title: "SECCIÓN",
                    name: "FRUTAS Y VERDURAS",
                    link: "/#/product?category=frutas-y-verduras",
                    buttonText: "VISÍTANOS",
                },
                {
                    title: "SECCIÓN",
                    name: "LÁCTEOS",
                    link: "/#/product?category=lacteos",
                    buttonText: "VISÍTANOS",
                },
                {
                    title: "SECCIÓN",
                    name: "BEBIDAS",
                    link: "/#/product?category=bebidas",
                    buttonText: "VISÍTANOS",
                },
                {
                    title: "SECCIÓN",
                    name: "CONGELADOS",
                    link: "/#/product?category=congelados",
                    buttonText: "VISÍTANOS",
                },
                {
                    title: "SECCIÓN",
                    name: "CARNES",
                    link: "/#/product?category=carnes",
                    buttonText: "VISÍTANOS",
                },
                {
                    title: "SECCIÓN",
                    name: "PANIFICADOS",
                    link: "/#/product?category=panificados",
                    buttonText: "VISÍTANOS",
                },
                {
                    title: "SECCIÓN",
                    name: "CONFITERIA",
                    link: "/#/product?category=confiteria",
                    buttonText: "VISÍTANOS",
                },
                {
                    title: "SECCIÓN",
                ...
                },
                {
                    title: "SECCIÓN",
                    name: "VIDA SANA",
                    link: "/#/product?category=vida-sana",
                    buttonText: "VISÍTANOS",
                },
                {
                    title: "SECCIÓN",
                    name: "BEBES",
                    link: "/#/product?category=bebes",
                    buttonText: "VISÍTANOS",
                },
                {
                    title: "SECCIÓN",
                    name: "HIGIENE",
                    link: "/#/product?category=higiene",
                    buttonText: "VISÍTANOS",
                },
                {
                    title: "SECCIÓN",
                    name: "COSMETICA",
                    link: "/#/product?category=cosmetica",
                    buttonText: "VISÍTANOS",
                },
                {
                    title: "SECCIÓN",
                    name: "FARMACIA",
                    link: "/#/product?category=farmacia",
                    buttonText: "VISÍTANOS",
                },
                {
                    title: "SECCIÓN",
                    name: "LIMPIEZA",
                    link: "/#/product?category=limpieza",
                    buttonText: "VISÍTANOS",
                },
                {
                    title: "SECCIÓN",
                    name: "HOGAR",
                    link: "/#/product?category=hogar",
                    buttonText: "VISÍTANOS",
                },
            ],
        };
